...
// BIPUSH - get a byte operand from bytecode, convert to int type, and push to opstack
type BIPUSH struct {
	val byte
}
...
// SIPUSH - get a short operand from bytecode, convert to int type, and push to opstack
type SIPUSH struct {
	val int16
}
